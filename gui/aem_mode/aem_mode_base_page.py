"""
This module contains the AEMModePage class that performs design on an air-entrained concrete mix,
...
class AEMModePage(tk.Frame):
    """
    Base class for the air-entrained mix design mode
    ...
    def display_left_tab(self):
        ...
        > The current design mode (AEM Design mode)
        > All stage buttons
        ...
        # Display the current design mode (Air entrained mix-design method)
        mode_text = load_tk_image(optimix_paths.aem_assets['aem_mode_text'])
