"""
This module displays mix design result for every stage in the cement/pfa
mix design mode
...
class StageOneResults(tk.Toplevel):
    ...
    def __init__(self, analyzer, controller, stage):
        ...
        # Window settings
        self.title(
            "OptiMix: Stage One Design Results (Portland Cement/Pulverised-Fuel Ash Concrete Mix)")  # window title
    ...
    def display_header(self):
        ...
        # Display text 'Portland Cement/Pulverised-Fuel Ash Concrete Mix'
        self.base_canvas.create_text(628,
                                     102,
                                     fill=white_color,
                                     font=font.Font(family=calibri, size=13, weight='bold'),
                                     text=f"(Portland Cement/pfa Concrete Mix)")
    ...
    def display_k(self, status: dict):
        ...
        if status['k'] == 'Specified':
            ...
            self.base_canvas.create_text(81,
                                         ...
                                         fill=white_color,
                                         anchor='nw',
                                         font=font.Font(family=cambria_math, size=13, slant='roman'),
            ...
            self.base_canvas.create_text(82,
                                         ...
                                         fill=white_color,
                                         anchor='nw',
                                         font=font.Font(family=calibri, size=11),
                                         text=k_text)
        ...
        if status['k'] == 'To be Determined':
            if status['sd'] == 'Specified':
                ...
                self.base_canvas.create_text(320,
                                             ...
                                             fill=white_color,
                                             activefill=np.random.choice(report_title_colors),
                                             font=font.Font(family=calibri, size=17, weight='bold'),
                ...
                self.base_canvas.create_text(95,
                                             ...
                                             fill=white_color,
                                             anchor='nw',
                                             font=font.Font(family=calibri, size=12),
                ...
                self.base_canvas.create_text(95,
                                             ...
                                             fill=white_color,
                                             anchor='nw',
                                             font=font.Font(family=calibri, size=13),
                                             text=plot_insight)
        ...
        if status['Margin'] == 'To be Determined':
            if status['k'] == 'To be Determined':
                ...
                self.base_canvas.create_text(90,
                                             ...
                                             fill=white_color,
                                             anchor='nw',
                                             font=font.Font(family=cambria_math, size=12, slant='italic'),
        ...
        if status['Margin'] == 'To be Determined':
            if status['k'] == 'To be Determined':
                ...
                parameters_text = f"The determination of the target mean strength (f\u2098) involves considering the specified\n" \
                                  f"characteristic strength (f\u05A4) of {fc} N/mm\u00b2 and a margin (M) of {m} N/mm\u00b2 as follows:\n"
                self.base_canvas.create_text(90,
                                             1510,
                                             fill=white_color,
                                             anchor='nw',
                ...
                fm_result = f"Target mean strength, f\u2098 = {fm_val} N/mm\u00b2 ({fc} + {m})."
    ...
    def display_target_wc_ratio(self, status: dict):
        ...
        if status['Margin'] == 'To be Determined':
            if status['k'] == 'To be Determined':
                ...
                fm_val = np.round(float(self.analyzer.calc_data['fm']), 2)
                fwc_ratio_intro = f"To determine the free-water/cement-pfa ratio, the approximate strength of {approx} N/mm\u00b2 \n" \
                ...
                final_wc_message = f"The required free-water/cement ratio of this portland cement/pfa mix is {np.round(self.analyzer.calc_data['initial_fwc_ratio'], 2)}."
                y_coord = 2525
...
class StageTwoResults(tk.Toplevel):
    ...
    def __init__(self, analyzer, controller, stage):
        ...
        # Window settings
        self.title(
            "OptiMix: Stage Two Design Results (Portland Cement/Pulverised-Fuel Ash Concrete Mix)")  # window title
        self.iconbitmap(optimix_paths.icons['icon_16'])  # window icon
        self.resizable(False, True)
    ...
    def display_fw_content(self, status: dict):
        ...
        if status['fw_content'] == 'Different Agg Types':
            ...
            # Place table 3, part a
            tab_iiia = load_tk_image(optimix_paths.doe_assets['table_iii_reporting_a'])
            self.base_canvas.tab_iii_rep_a = tab_iiia
            self.base_canvas.create_image(
                387.00000762939453,
                430.99998474121094,
                image=tab_iiia
            ...
            # Place table 3, part b
            tab_iiib = load_tk_image(optimix_paths.doe_assets['table_iii_reporting_b'])
            self.base_canvas.tab_iii_rep_b = tab_iiib
            self.base_canvas.create_image(
                403.50000762939453,
                845.99998474121094,
                image=tab_iiib
            ...
            # Background for insights and results
            rec_pfa = load_tk_image(optimix_paths.doe_assets['report_rectangles'][6])
            self.base_canvas.rec_pfa = rec_pfa
            self.base_canvas.create_image(
                390.00000762939453,
                1240.99998474121094,
                image=rec_pfa
            ...
            initial_fw = self.analyzer.calc_data['initial_fw_content']
            reduction = self.analyzer.calc_data['fw_reduction']
            p = self.analyzer.data['Specified variables']['pfa Proportion']
            ...
            # Display text
            text = f"For a portland cement-pfa concrete mix featuring a maximum aggregate size of {max_agg_size}mm, \n" \
                   ...
                   f"{vocab[slump_value][1]}, the required free-water content from part A \n" \
                   f"in the table above is estimated below: \n" \
                   f"                                             \n" \
                   f"0.67W\u2086 + 0.33W\u05A4 = (0.67 × {wf}kg/m\u00b3) + (0.33 × {wc}kg/m\u00b3) = {np.round(initial_fw, 1)} kg/m\u00b3\n" \
                   f"                                             \n" \
                   ...
                   f"    \n" \
                   f"With a specified proportion of {p}% in the cement-pfa mix, in reference to part B \n" \
                   f"in the table above, the water content will be reduced by {np.round(reduction, 1)} kg/m\u00b3 \n" \
                   f"The required free-water content for the cement-pfa mix is {np.round(w, 1)} kg/m\u00b3."
            ...
            self.base_canvas.create_text(333,
                                         ...
                                         fill=white_color,
                                         activefill=np.random.choice(report_title_colors),
                                         font=font.Font(family=calibri, size=19, weight='bold'),
                                         text=title)
            ...
            # Background for insights and results
            rec_pfa = load_tk_image(optimix_paths.doe_assets['report_rectangles'][2])
            self.base_canvas.rec_pfa = rec_pfa
            self.base_canvas.create_image(
                390.00000762939453,
                1200.99998474121094,
            ...
            text = f"For a portland cement-pfa concrete mix featuring a maximum aggregate size of {max_agg_size}mm, \n" \
                   ...
                   f"the free-water content from part A in the table above is {initial_fw} kg/m\u00b3.\n" \
                   f"\n" \
                   f"With a specified proportion of {p}% in the cement-pfa mix, in reference to part B \n" \
                   f"in the table above, the water content will be reduced by {np.round(reduction, 1)} kg/m\u00b3 \n" \
                   f"The required free-water content for the cement-pfa mix is {np.round(w, 1)} kg/m\u00b3."
...
class StageThreeResults(tk.Toplevel):
    ...
    Methods:
        ...
        - display_pfa_content(): Displays the calculations regarding the determination of pfa content
        - display_specified_limits(status): Displays the calculations regarding cement content checks
        - display_wcf_limits(status): Displays W/C+F limit checks based on the user's specifications.
        - display_results(): Displays all results
        - fix_boundary(): fix scroll boundary in the TopLevel window
    """
    ...
    def __init__(self, analyzer, controller, stage):
        ...
        # Window settings
        self.title(
            "OptiMix: Stage Three Design Results (Portland Cement/Pulverised-Fuel Ash Concrete Mix)")  # window title
        self.iconbitmap(optimix_paths.icons['icon_16'])  # window icon
        self.resizable(False, True)
    ...
    def display_cement_content_calculation(self):
        """
        Display the calculations regarding the determination of portland cement content.
        - Background tab
        - Title
        - The calculation of the portland cement content
        """
        # Display the background tab
        ...
        self.base_canvas.create_text(287.3,
                                     200,
                                     fill=white_color,
                                     activefill=np.random.choice(report_title_colors),
                                     font=font.Font(family=calibri, size=17, weight='bold'),
                                     text="Determination of Portland Cement Content")

        # Display calculated cement content
        fw_content = np.round(float(self.analyzer.calc_data["fw_content"]), 2)
        initial_fwc_ratio = np.round(float(self.analyzer.calc_data["initial_fwc_ratio"]), 2)
        c = np.round(float(self.analyzer.calc_data["init_C"]), 2)
        p = np.round(float(self.analyzer.data['Specified variables']['pfa Proportion']), 2)
        k = self.analyzer.data['Additional info']['Cementing Efficiency Factor']

        text = f"Given a free-water content (W) of {fw_content}kg/m\u00b3, a specified cementing efficiency factor (k)\n" \
               f"{k}, a predetermined W / (C + {k}F) of {initial_fwc_ratio}, and a specified pfa proportion (p) of {p}%.\n" \
               f"The cement content (C) is determined with the expression below: \n" \
               f"C = (100 - p)W / (100 - (1-k)p) × (W / (C + kF)). \n" \
               f"Substituting the values, C = (100 - {p}) × {fw_content} / (100 - (1 - {k}) × {p}) × {initial_fwc_ratio}. \n" \
               f"This results in a portland cement content of {c} kg/m\u00b3."
    ...
    def display_pfa_content(self):
        """
        Display the calculations regarding the determination of pfa content.
        - Background tab
        - Title
        - The calculation of the pfa content
        """
        # Display the background tab
        ...
        # Show the tab's title, "Determination of pfa content"
        self.base_canvas.create_text(220.3,
                                     430,
                                     fill=white_color,
                                     activefill=np.random.choice(report_title_colors),
                                     font=font.Font(family=calibri, size=17, weight='bold'),
                                     text="Determination of pfa Content")

        # Display pfa content calculation
        c = np.round(float(self.analyzer.calc_data["init_C"]), 2)
        p = np.round(float(self.analyzer.data['Specified variables']['pfa Proportion']), 2)
        f = np.round(float(self.analyzer.calc_data["init_F"]), 2)

        text = f"With a pfa proportion (p) of {p}% and a portland cement content (C) of {c} kg/m\u00b3, \n" \
               f"The required pfa content (F) in the cement-pfa concrete mix is determined below: \n" \
               f"\n" \
               f"F = P × C / 100 - P. \n" \
               f"F = {p} × {c} / 100 - {p}. \n" \
               f"The required pfa content of the mix is {f} kg/m\u00b3"
    ...
    def display_specified_limits(self, status: dict):
        ...
        # Display total cement content
        c = np.round(float(self.analyzer.calc_data['init_C']), 2)
        f = np.round(float(self.analyzer.calc_data['init_F']), 2)
        total_cement = np.round(float(self.analyzer.calc_data['calc_cement_content']), 2)

        tc = f"The combined portland cement and pfa content in the mix is expressed below: \n" \
             f"{c}kg/m\u00b3 + {f}kg/m\u00b3 = {total_cement} kg/m\u00b3."
        ...
        if status["max_content"] == 'Specified' and status["min_content"] == 'Specified':
            ...
            if status["cement_content"] == "Within Range":
                ...
                text = f"The combined cement content, {calc_content}kg/m\u00b3, falls within the specified maximum\n" \
                       f"and minimum limits, making it the required cement+pfa content in the concrete mix."
                ...
                _c = np.round(float(self.analyzer.calc_data['init_ii_C']), 2)
                _f = np.round(float(self.analyzer.calc_data['init_ii_F']), 2)
                ...
                text = f"The combined cementitious content is below the specified minimum of {min_content}kg/m\u00b3.\n" \
                       f"To meet this requirement, the mix is adjusted to incorporate {_c}kg/m\u00b3 of Portland cement\n" \
                       f"and {_f}kg/m\u00b3 of PFA, ensuring a total cementitious content of {min_content}kg/m\u00b3."
            ...
            if status["cement_content"] == "Below Minimum":
                ...
                text = f"The combined cement+pfa content, {calc_content}kg/m\u00b3, is more than the specified minimum, \n" \
                       f"making it the required cementitious content for the Portland cement + pfa concrete mix."
            ...
            if status["cement_content"] == "Within Range":
                ...
                text = f"The combined cement content, {calc_content}kg/m\u00b3, is lower than the specified maximum, \n" \
                       f"making it the required cementitious content of the Portland cement/pfa concrete mix."
            ...
            specs = f"There are no specified maximum or minimum cement content limits,\n" \
                    f"the combined cementitious content required for the concrete mix is {cement_content}kg/m\u00b3.\n" \
    ...
    def display_wcf_limits(self, status: dict):
        """
        Displays W/C+F limit checks based on the user's specifications.
        - Background tab
        - Title
        - W/C+F Limit checks
        :param status: (dict): Dictionary class containing current state before displaying report
        """
        # Place the background tab
        rec_iv = load_tk_image(optimix_paths.doe_assets['report_rectangles'][2])
        self.base_canvas.rec_iv = rec_iv
        self.base_canvas.create_image(
            390.00000762939453,
            960.99998474121094,
            image=rec_iv
        ...
        # Show the tab's title, "Free-water/cement ratio comparison"
        self.base_canvas.create_text(259,
                                     890,
                                     fill=white_color,
                                     activefill=np.random.choice(report_title_colors),
                                     font=font.Font(family=calibri, size=17, weight='bold'),
                                     text="Free-Water/Cement Ratio Comparison")

        # Display wcf ratio calculation
        w = np.round(float(self.analyzer.calc_data['fw_content']), 2)
        c_f = np.round(float(self.analyzer.calc_data['cement_content']), 2)
        wcf = np.round(float(self.analyzer.calc_data['calc_wcf_ratio']), 2)

        wcf_text = f"With a free-water content of {w}kg/m\u00b3 and a total cementitious content of {c_f}kg/m\u00b3, \n" \
                   f"The required (W / C + F) ratio = {w}kg/m\u00b3 / {c_f}kg/m\u00b3 = {wcf}."
        ...
        if status['limiting wcf'] == 'Specified':
            # Display the maximum free-water to cement ratio
            max_wcf = self.analyzer.data['Specified variables']['Maximum free water-cement ratio']
            max_wcf_text = f"The specified maximum free water-cement ratio is {max_wcf}."
            self.base_canvas.create_text(76,
                                         960,
                                         fill=white_color,
                                         anchor='nw',
            ...
            # Cement ratio comparison display
            if status['wcf_status'] == 'More than Maximum':
                adj_cement_content = np.round(float(self.analyzer.calc_data['final_cementitious_content']), 2)
                adj_c = np.round(float(self.analyzer.calc_data["C"]), 2)
                adj_f = np.round(float(self.analyzer.calc_data["F"]), 2)

                text = f"The calculated (W / C + F) exceeds the specified maximum. To meet this requirement, \n" \
                       f"the mix is adjusted to incorporate a total cementitious content of {adj_cement_content}kg/m\u00b3,\n" \
                       f"{adj_c}kg/m\u00b3 of Portland cement and {adj_f}kg/m\u00b3 of PFA.\n"
            ...
            elif status['wcf_status'] == 'Less than Maximum':
                cement_content = np.round(float(self.analyzer.calc_data['final_cementitious_content']), 2)
                _c = np.round(float(self.analyzer.calc_data["C"]), 2)
                _f = np.round(float(self.analyzer.calc_data["F"]), 2)

                text = f"The calculated (W / C + F) is lower than the specified maximum. \n" \
                       f"No further changes will be made. The total cementitious content in the mix is {cement_content}kg/m\u00b3. \n" \
                       f"The required Portland cement content is {_c}kg/m\u00b3. The pfa content is {_f} kg/m\u00b3. "
        ...
        elif status['limiting wcf'] == 'Unspecified':
            cement_content = np.round(float(self.analyzer.calc_data['final_cementitious_content']), 2)
            _c = np.round(float(self.analyzer.calc_data["C"]), 2)
            _f = np.round(float(self.analyzer.calc_data["F"]), 2)

            text = f"There is no specified maximum free water-cement ratio. \n" \
                   f"No further changes will be made. The total cementitious content in the mix is {cement_content}kg/m\u00b3. \n" \
                   f"The required Portland cement content is {_c}kg/m\u00b3. The pfa content is {_f} kg/m\u00b3. "
    ...
    def display_results(self):
        """
        Displays the determination of portland cement content, pfa content, total (cement + pfa) comparison, and w/c+f comparison.
        Cases:
        ...
        - When the w/c+f is less than a specified limit
        - When the w/c+f is more than a specified limit
        """
        ...
        # Display pfa content calculations
        self.display_pfa_content()

        # Requirements check
        self.display_specified_limits(status=current_status)
        self.display_wcf_limits(status=current_status)
...
class StageFourResults(tk.Toplevel):
    ...
    def __init__(self, analyzer, controller, stage):
        ...
        # Window settings
        self.title(
            "OptiMix: Stage Four Design Results (Portland Cement/Pulverised-Fuel Ash Concrete Mix)")  # window title
        self.iconbitmap(optimix_paths.icons['icon_16'])  # window icon
        self.resizable(False, True)
    ...
    def display_total_agg_content(self):
        ...
        if self.analyzer.specified_conc_density:
            ...
            # Needed parameters
            w = np.round(float(self.analyzer.calc_data["fw_content"]), 2)
            c = np.round(float(self.analyzer.calc_data["final_cementitious_content"]), 2)
            ...
            text = f"The total cementitious content ({c} kg/m\u00b3) and the free-water content\n" \
                   ...
                   f"The total aggregate content of the Portland cement/pfa concrete mix is {tac}kg/m\u00b3. \n"
            ...
            if self.analyzer.tac_content['ssd_value'] == 'unspecified':
                if self.analyzer.tac_content['Agg_status'] == 'Same types, crushed':
                    # Plot figure 5
                    self.analyzer.plot_figure_v(status='crushed or uncrushed, unspecified', mode='PFA')
                    ...
                    # Text
                    display_text = f"A relative density of 2.7 is assumed for crushed aggregates. \n" \
                                   f"From the plot above, the relative density and the free-water content \n" \
                                   f"({w} kg/m\u00b3) correspond to a wet concrete density of {d} kg/m\u00b3 \n" \
                                   f"\n" \
                                   f"The total cementitious content ({c} kg/m\u00b3) and the free-water content\n" \
                    ...
                    # Text
                    display_text = f"A relative density of 2.6 is assumed for uncrushed aggregates. \n" \
                                   f"From the plot above, the relative density and the free-water content \n" \
                                   f"({w} kg/m\u00b3) correspond to a wet concrete density of {d} kg/m\u00b3 \n" \
                                   f"\n" \
                                   f"The total cementitious content ({c} kg/m\u00b3) and the free-water content\n" \
                    ...
                    # Plot figure 5
                    self.analyzer.plot_figure_v(status='crushed and uncrushed, unspecified', mode='PFA')
                    ...
                    # Text
                    display_text = f"A relative density of 2.65 is assumed for crushed and uncrushed aggregates. \n" \
                                   f"From the plot above, the relative density and the free-water content \n" \
                                   f"({w} kg/m\u00b3) correspond to a wet concrete density of {d} kg/m\u00b3 \n" \
                                   f"\n" \
                                   f"The total cementitious content ({c} kg/m\u00b3) and the free-water content\n" \
                ...
                # Plot figure 5
                self.analyzer.plot_figure_v(status='specified', mode='PFA')
                ...
                # Text
                display_text = f"From the plot above, the specified relative density ({rd}) and the free-water content \n" \
                               f"({w} kg/m\u00b3) correspond to a wet concrete density of {d} kg/m\u00b3 \n" \
                               f"\n" \
                               f"The total cementitious content ({c} kg/m\u00b3) and the free-water content\n" \
                               f"({w} kg/m\u00b3) are subtracted from the estimated density of the concrete mix \n" \
...
class StageFiveResults(tk.Toplevel):
    ...
    Methods:
        ...
        - display_pfa_quantity(report_no, canvas): Displays the 'pfa _____ kg'
    ...
    def __init__(self, analyzer, controller, stage):
        ...
        # Window settings
        self.title(
            "OptiMix: Stage Five Design Results (Portland Cement/Pulverised-Fuel Ash Concrete Mix)")  # window title
        self.iconbitmap(optimix_paths.icons['icon_16'])  # window icon
        self.resizable(False, True)
    ...
    def display_recommended_fineagg_prop(self, canvas):
        ...
        text = f"For a maximum aggregate size of {max_agg_size}mm, a slump range of {vocab[slump_value][0]} \n" \
               ...
               f"fine aggregate in the Portland cement/pfa concrete mix is determined using the figure below:"
        ...
        # Place the visualization
        fig_vi_plot = self.analyzer.fig_vi_png_image
    ...
    def roundoff_to_nearest_five_kg(self, report_no: str, canvas):
        ...
        if report_no == 'a':
            ...
            # Round off the pfa content quantity
            pfa_new_txt = f'{self.analyzer.design_results["pfa"][self.result_accuracy_switch]}'
            canvas.itemconfigure(tagOrId='pfa_qty', text=pfa_new_txt)
    ...
    def display_cement_quantity(self, report_no: str, canvas):
        ...
        :param canvas: (tk.Canvas): the target canvas for the top level widget
        :param report_no: There are two final mix design reports for now, "a" & "b"
        """
        if report_no == 'a':
            # Load the image
    ...
    def display_pfa_quantity(self, report_no: str, canvas):
        """
        Displays the 'PFA _____ kg'
        :param canvas: (tk.Canvas): the target canvas for the top level widget
        :param report_no: There are two final mix design reports for now, "a" & "b"
        """
        if report_no == 'a':
            # Load the image
            pfa_a = load_tk_image(optimix_paths.pfa_assets['pfa_report_a'])
            canvas.pfa_a = pfa_a
            ...
            # Display 'kg'
            self.quantity_unit(x=340, y=497, canvas=canvas)

        elif report_no == 'b':
            # Load the image
            pfa_a = load_tk_image(optimix_paths.pfa_assets['pfa_report_a'])
            canvas.pfa_a_tm = pfa_a
            ...
            # Display 'kg'
            self.quantity_unit(x=340, y=1057, canvas=canvas)
    ...
    def display_water_quantity(self, report_no: str, canvas):
        ...
        if report_no == 'a':
            ...
            # Display 'kg'
            self.quantity_unit(x=340, y=577, canvas=canvas)
            ...
            # Display 'kg'
            self.quantity_unit(x=340, y=1137, canvas=canvas)
    ...
    def display_txt_quantities(self, report_no: str, canvas, mix_design_results):
        ...
        if report_no == 'a':
            ...
            # Display the pfa content
            pfa_txt = f'{mix_design_results["pfa"][self.result_accuracy_switch]}'
            canvas.create_text(267.5,
                               495,
                               fill=white_color,
                               anchor='center',
    ...
    def display_report_a(self, canvas):
        ...
        instruction = f"The quantities of the constituent materials per m\u00b3 required to achieve a \n" \
                      f"concrete strength of {x_strength} N/mm\u00b2 after {days} days are shown below: "
        ...
        # Display pfa____ kg
        self.display_pfa_quantity(report_no='a', canvas=canvas)
    ...
    def config_bv_display(self, canvas, batch_design_data: dict):
        ...
        # Adjust the batch volume of the pfa content quantity
        pfa_new_txt = f'{batch_design_data["pfa"][self.result_accuracy_switch]}'
        canvas.itemconfigure(tagOrId='pfa_qty_b', text=pfa_new_txt)
    ...
    def adjust_batch_volume(self, canvas):
        ...
        if all(fill_status):
            ...
            self.analyzer.batch_to_desired_volume(mode='PFA', mix_design_data=self.analyzer.design_results)
    ...
    def display_trial_mix_report(self, canvas):
        ...
        # Display pfa___ kg
        self.display_pfa_quantity(report_no='b', canvas=canvas)
    ...
    def display_final_results(self):
        ...
        # Top level window configuration
        self.title("OptiMix: Final Design Results (Portland Cement/Pulverised-Fuel Ash Concrete Mix)")
