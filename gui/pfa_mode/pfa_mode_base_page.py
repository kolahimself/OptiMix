"""
This module contains the PFAModePage class that performs mix design for purified furnace ash concrete.
All related GUI, data collection, computations are performed in this script

"""

from gui.pfa_mode.pfa_mode_stages import StageOne, StageTwo, StageThree, StageFour, StageFive
from gui.pfa_mode.pfa_results import StageOneResults, StageTwoResults, StageThreeResults, StageFourResults, StageFiveResults
...
class PFAModePage(tk.Frame):
    """
    Base class for the cement/pfa concrete mix design mode
    ...
    def __init__(self, master, controller):
        ...
        # Create a list of all report viewing top levels
        # self.result_top_levels = [StageOneResults(self.analyzer)]
    ...
    def display_left_tab(self):
        ...
        > The current design mode (Pulverized fuel ash mix design)
        > All stage buttons
        ...
        # Display the current design mode (Pfa mix design)
        mode_text = load_tk_image(optimix_paths.pfa_assets['pfa_mode_text'])
        self.tab_canvas.pfa_mode_text = mode_text
        self.tab_canvas.create_image(
            121.58000183105469,
            128.13999938964844,
            image=mode_text
    ...
    def save_data(self, stage_index):
        """
        Ensures that the collected data is saved, this is bound to the click of any button
