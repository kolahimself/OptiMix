"""
This module contains the DOEModePage class that performs Concrete Mix Design using British DOE method,
All related GUI, data collection, computations are performed in this script

"""

from gui.doe_mode.doe_mode_stages import StageOne, StageTwo, StageThree, StageFour, StageFive
from gui.doe_mode.doe_results import StageOneResults, StageTwoResults, StageThreeResults, StageFourResults, StageFiveResults
...
class DoeModePage(tk.Frame):
    ...
    def display_left_tab(self):
        ...
        > The current design mode (British - DOE mode)
        > All stage buttons
        ...
        # Display the current design mode (British DOE method)
        mode_text = load_tk_image(optimix_paths.doe_assets['doe_mode_text'])
        self.tab_canvas.doe_mode_text = mode_text
        self.tab_canvas.create_image(
            104.58000183105469,
            127.13999938964844,
            image=mode_text
